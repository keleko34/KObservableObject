...
g&&(c=c[a]);for(var b=0,e=c.length;b<e;b++)if(c[b].toString()===g.toString()){c.splice(b,1);break}return this}}function v(a,c,d){return{get:function(){return a[c]},set:function(d){a[c]=d},enumerable:d.enumerable,configurable:d.configurable}}function b(a,c,d){return{value:a,writable:!!c,enumerable:!1,configurable:!!d}}function r(a,c){var d=a,b=a,e=t,f=w;return{get:function(){return d},set:function(a,h){!0!==e(this,c,"set",a,d)&&(b=d,d=a,f(this,c,"update",d,b),h||this.callSubscribers(c,d,b))},configurable:!0,
enumerable:!0}}var f={},k={add:[],set:[],remove:[]},q=function(a,c,d,b,e,f){a=new h(a,c,d,b,e,f);c=0;d=k[d];for(b=d.length;c!==b&&(d[c](a),!a._stopPropogration);c++);return a._preventDefault},e={},t=function(a,c,d,b,e){a=new h(a,c,d,b,e);f.onset(a);return a._preventDefault},w=function(a,c,d,b,e){a=new h(a,c,d,b,e);f.onupdate(a);return a._preventDefault};Object.defineProperties(f,{__kbname:b(l||"",!0,!0),__kbref:b(m?m.__kbref||m:f,!0,!0),__kbscopeString:b(u||"",!0,!0),__kbImmediateParent:b(m||null,
!0,!0),add:b(function(a,c){if(void 0===this[a]){var d=new h(this,a,"add",c,void 0);f.onadd(d);!0!==d._preventDefault&&(Object.defineProperty(this,a,r.call(this,c,a)),q(this,a,"add",c,void 0,arguments))}else console.error("Your attempting to add the property: ",a," that already exists on",this,"try using set or direct set instead");return this}),addPointer:b(function(a,c,d){var b=new h(this,d||c,"add",a[c],void 0);f.onadd(b);!0!==b._preventDefault&&(b=Object.getOwnPropertyDescriptor(a,c),Object.defineProperty(this,
d||c,v(a,c,b)),q(this,d||c,"add",a[c],void 0,arguments));return this}),set:b(function(a,c,d){if(void 0===this[a])this.add(c,a);else if(!0!==t(this,a,"set",c)){var b=this[a];void 0===Object.getOwnPropertyDescriptor(this,a).value?Object.getOwnPropertyDescriptor(this,a).set.call(this,c,d):Object.defineProperty(this,a,r.call(this,c,a));q(this,a,"set",c,b,arguments)}return this}),remove:b(function(a){if(void 0===this[a])return console.error("Your attempting to remove the property: ",a," that does not exist on ",
