...
p(c)&&(c=Object.getOwnPropertyDescriptor(a,d),Object.defineProperty(this,e.key,B(a,d,c)),e.type="postadd",h(e));return this}),prototype:c(function(a,d){void 0===this[a]?Object.defineProperty(this.__proto__,a,c(d,!0,!0)):console.error("Your attempting to add the your method with the prop: ",a," that already exists");return this}),set:c(function(a,d,b){var c=new m(this,a,"set",d,this[a],arguments,"__kblisteners"),e=new n("set",a,c,arguments);!0!==h(e)&&(void 0===this[a]?this.add(e.key,e.args[1]):!0!==
